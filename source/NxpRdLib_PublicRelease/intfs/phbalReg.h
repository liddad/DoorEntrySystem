...
typedef struct
{
    uint16_t   wId;         /**< Layer ID for this BAL component, NEVER MODIFY! */					/**< Layer ID for this BAL component, NEVER MODIFY! */
    uint32_t   spiFD;
    uint8_t    spiMode;
    uint8_t    spiChannel;
    uint32_t   spiSpeed;
...
#define PHBAL_REG_LPC12XXSPI_ID         0x0DU       /**< ID for LPC12XX SPI component */

/**
 * \brief NXP LPC12XX SPI BAL parameter structure
 */
typedef struct
{
    uint16_t    wId;					/**< Layer ID for this BAL component, NEVER MODIFY! */
} phbalReg_Lpc12XXSpi_DataParams_t;

/**
 * \brief Initialise the NXP LPC12XX SPI BAL component.
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 */
phStatus_t phbalReg_Lpc12XXSpi_Init(
        phbalReg_Lpc12XXSpi_DataParams_t * pDataParams,		/**< [In] Pointer to this layer's parameter structure. */
        uint16_t wSizeOfDataParams							/**< [In] Specifies the size of the data parameter structure. */
);

#endif /* NXPBUILD__PHBAL_REG_LPC12XXSPI */

#ifdef NXPBUILD__PHBAL_REG_LPC13XXSPI

#define PHBAL_REG_LPC13XXSPI_ID         0x0EU       /**< ID for LPC1768 SPI component */

/**
 * \brief NXP LPC13XX SPI BAL parameter structure
 */
typedef struct
{
    uint16_t    wId;					/**< Layer ID for this BAL component, NEVER MODIFY! */
} phbalReg_Lpc13XXSpi_DataParams_t;

/**
 * \brief Initialise the NXP LPC13XX SPI BAL component.
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 */
phStatus_t phbalReg_Lpc13XXSpi_Init(
        phbalReg_Lpc13XXSpi_DataParams_t * pDataParams,		/**< [In] Pointer to this layer's parameter structure. */
        uint16_t wSizeOfDataParams							/**< [In] Specifies the size of the data parameter structure. */
);

#endif /* NXPBUILD__PHBAL_REG_LPC13XXSPI */

#ifdef NXPBUILD__PHBAL_REG_RPISPI

#define PHBAL_REG_RPISPI_ID         0x0FU       /**< ID for RPI SPI component */

/**
 * \brief NXP RPI SPI BAL parameter structure
 */
typedef struct
{
    uint16_t   wId;					/**< Layer ID for this BAL component, NEVER MODIFY! */
